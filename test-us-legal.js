#!/usr/bin/env node
// Test script for US Legal MCP Server

import USLegalAPI from './dist/us-legal-apis.js';

async function testUSLegalAPI() {
  console.log('🇺🇸 Testing US Legal MCP Server');
  console.log('================================\n');
  ...
  try {
    ...
    console.log('🇺🇸 US Legal MCP Server is working correctly.');
