    ...
    switch (command) {
      case "bills":
        ...
        bills.forEach((bill, i) => {
          ...
          console.log(
            `   ${bill.congress}-${bill.type.toUpperCase()}-${bill.number}`,
          );
      ...
      case "regulations":
        ...
        const regulations = await usLegalAPI.federalRegister.searchDocuments(
          query,
          limit,
        );
      ...
      case "code":
        ...
        const codeSections = await usLegalAPI.usCode.searchCode(
          query,
          undefined,
          limit,
        );
        ...
        codeSections.forEach((section, i) => {
          console.log(
            `${i + 1}. Title ${section.title}, Section ${section.section}`,
          );
      ...
      default:
        ...
        console.log(
          "Available commands: bills, regulations, code, comments, all",
        );
    }
  } catch (error: any) {
